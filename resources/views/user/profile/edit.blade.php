...
<body class="h-full">
    ...
    <section class="bg-purple-400 dark:bg-gray-900">
        <div class="max-w-2xl px-4 py-8 mx-auto lg:py-16">
            <h1 class="mb-4 text-2xl text-center font-bold text-gray-900 dark:text-white">Edit Profil</h1>
            <form action="" method="POST">
                <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                    ...
                    <div class="sm:col-span-2">
                        <label for="no_handphone" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nomor Handphone</label>
                        <input type="number" name="no_hp" id="no_hp" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="098651356" placeholder="Masukkan Nomor Handphone">
                    </div>

                    <div class="sm:col-span-2">
                        <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email</label>
                        <input type="email" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="orry@gmail.com" placeholder="Masukkan email" required="">
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="flex items-center mb-4">
                            ...
                            <label for="laki_laki" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Laki-laki</label>
                        </div>
